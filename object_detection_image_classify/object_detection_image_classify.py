...
def ssd_mobile_detection(image_in, image_out):
...
def object_detection(image_in, image_out=''):
    if image_out == '':
        if os.path.isfile(image_in):
            ...
            return '', None
    result = ssd_mobile_detection(image_in, image_out)
    return image_out, result


object_detection(r'object_detection\test_images\image.jpg')
